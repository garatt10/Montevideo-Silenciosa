...
import { BarChart3, CheckCircle2, FileText, Info, LogOut } from 'lucide-react'
    ...
    <section className="perfil-cuenta perfil-completar-card">
      <div className="perfil-auth-intro">
        ...
        <p className="perfil-cuenta-dato">
          Para enviar reportes necesitamos tu nombre, apellido y cédula.
        </p>
      </div>
      <div className="perfil-completar">
        ...
        <label className="form-field">
          <span>Apellido</span>
          <input value={apellido} onChange={e => setApellido(e.target.value)} placeholder="Ej: Rodriguez" />
        </label>
        <label className="form-field">
          <span>Cédula</span>
          <input
        ...
        {error && <p className="auth-mensaje">{error}</p>}
          ...
          {mediciones.length === 0 ? (
            <p className="perfil-vacio">
              {usuario
                ? cargandoDatos
                  ? 'Cargando...'
                  : 'Todavía no hay mediciones guardadas.'
                : 'Ingresa para ver tu historial de mediciones.'}
            </p>
          ) : (
          ...
          {reportes.length === 0 ? (
            <p className="perfil-vacio">
              {usuario
                ...
                : 'Ingresa para ver tu historial de reportes.'}
            </p>
          ) : (
            <div className="historial-lista">
